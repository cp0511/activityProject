...
public interface UserService {
	 ...
	 */
	List<EasyUIOptionalTreeNode> findUserRole(String user_id);
	/**
	 * 
	...
	* @date 2019年2月21日下午12:08:37
	 */
	List<Role> findUserRoleByUserid(String user_id);
	/**
	 * 
	 ...
	 */
	GlobalResult updateUserRole(String user_id, String checkedIds);
