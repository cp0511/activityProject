...
public class UserController {
	...
	@ResponseBody
	public List<EasyUIOptionalTreeNode> findUserRole(@RequestParam(value = "id", required = true) String user_id) {
	...
	@ResponseBody
	public GlobalResult updateUserRole(@RequestParam(value = "id", required = true) String user_id,
