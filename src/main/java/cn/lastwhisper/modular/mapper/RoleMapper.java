...
public interface RoleMapper {
	 ...
	 */
	public List<String> selectRoleMenuidByRoleid(@Param("roleuuid") String roleuuid);
	 ...
	 */
	public List<Integer> selectUseridByRoleuuid(@Param("roleuuid") String roleuuid);
	 ...
	 */
	public void insertRolemenu(@Param("menuuuid") String menuuuid, @Param("roleuuid") String roleuuid);
	 ...
	 * @return
	 */
	public Integer deleteRoleById(@Param("uuid") String uuid);
	 ...
	 */
	public void deleteMenuidByRoleid(@Param("roleuuid") String roleuuid);
