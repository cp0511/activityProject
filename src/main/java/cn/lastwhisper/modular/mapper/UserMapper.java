...
public interface UserMapper {
	 ...
	 */
	public List<Role> selectUserRole(@Param("user_id") String user_id);
	/**
	 * 
	...
	* @date 2019年2月16日下午3:53:14
	 */
	public void insertUserRole(@Param("user_id") String user_id,@Param("roleuuid") String roleuuid);
	/**
	 * 
	 * @Title: updateUser   
	 * @Description: 更新用户信息
	 ...
	 * @return
	 */
	public Integer updatePwdById(@Param("user_id") String user_id,@Param("user_pwd") String user_pwd);
	/**
	 * 
	 * @Title: updateUser   
	 ...
	 * @return
	 */
	public Integer deleteUserById(@Param("user_id") String user_id);
